...
const Banner = ({ title, description, image }) => {
    return (
        <section className="relative w-full flex items-center justify-between   bg-gradient-to-r from-blush to-peach">
            {/* Left Side - Title and Description */}
            <div className="flex flex-col py-16 px-6 lg:px-12 space-y-4 max-w-lg text-left">
